		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<button href="{{-- {{ route('itemdetailpage') }} --}}" class="addtocartBtn text-decoration-none" data-id="{{ $item->id }}" data-price="{{ $item->price }}" data-name="{{ $item->name }}" data-photo="{{ $item->photo }}">Add to Cart</button>
		                    </div>
		                </div> 
		                @endforeach
		            </div>
...
@endsection
@section('script')
<script type="text/javascript" src="{{ asset('front/main.js') }}"></script>
@endsection